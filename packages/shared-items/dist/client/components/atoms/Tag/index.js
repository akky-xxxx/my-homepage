...
var COLOR_FEFEFE = Color_1.Color.COLOR_FEFEFE;
exports.Tag = styled_components_1.default.span(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background-color: transparent;\n  border-radius: ", ";\n  cursor: pointer;\n  font-size: ", ";\n  padding: 4px;\n  transition: color ", " ", ",\n    background-color ", " ", ";\n\n  &:hover {\n    color: ", ";\n  }\n\n  ", "\n"], ["\n  background-color: transparent;\n  border-radius: ", ";\n  cursor: pointer;\n  font-size: ", ";\n  padding: 4px;\n  transition: color ", " ", ",\n    background-color ", " ", ";\n\n  &:hover {\n    color: ", ";\n  }\n\n  ", "\n"])), Radius_1.Radius.SINGLE, Font_1.Font.SIZE.SMALL, DURATION, TIMING_FUNCTION, DURATION, TIMING_FUNCTION, COLOR_FEFEFE, getColors_1.getColors);
